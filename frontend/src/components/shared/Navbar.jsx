                    ...
                    <ul className="flex font-medium items-center gap-10 text-sm text-gray-700">
                        {
                            user && user.role === 'recruiter' ? (<>
                                <li className="hover:text-[#F83002] cursor-pointer transition"><Link to="/admin/jobs">Jobs</Link></li>
                                <li className="hover:text-[#F83002] cursor-pointer transition"><Link to="/admin/companies">Companies</Link></li>
